...
//Public customer route - no login required
Route::get('/', function () {
...
Route::get('/api/parking-slots', function () {
    // Get all slots grouped by zone_name
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    // Dashboard - IMPORTANT: Use the controller method
